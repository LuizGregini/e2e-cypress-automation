:root {
  --main-background-color: #1478a2;
  --highlight-background-color: #c8f0fb;
  --pass-color: #21bf41;
  --text-color: #000000;
  --light-text-color: #160f31;
  --header-color: #00348d;
  --border-color: #000000;
  --hover-text-color: #000000;
}

/* Test runner main background */
main,
body,
.bg-white {
...
.reporter .runnable.test.runnable-pending .runnable-title {
  color: #9f07c9 !important;
}

.reporter .toggle-specs-wrapper button .toggle-specs-text {
...
*[fill].icon-dark-gray-500,
.icon-light-gray-50 > *[fill].icon-light {
  fill: var(--highlight-background-color) !important;
}
...
.reporter .command-state-passed .command-message {
  color: var(--text-color) !important;
}
...
.hover\:bg-indigo-50:hover {
  background-color: var(--hover-text-color) !important;
}
